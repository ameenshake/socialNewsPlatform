CREATE TABLE posts (postID INT NOT NULL AUTO_INCREMENT PRIMARY KEY, title VARCHAR(500) NOT NULL, link VARCHAR(500), content TEXT, image BLOB, username VARCHAR(200) NOT NULL, category VARCHAR(200) NOT NULL, datePosted DATETIME NOT NULL);
